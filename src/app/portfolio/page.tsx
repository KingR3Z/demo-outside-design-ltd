...
const projectImages = [
  { src: "/images/portfolio/project-01.jpg", title: "Garden Clearance & Groundwork", location: "Norfolk Park, Sheffield" },
  { src: "/images/portfolio/project-02.jpg", title: "Hard Landscaping Construction", location: "Norfolk Park, Sheffield" },
  { src: "/images/portfolio/project-03.jpg", title: "Pergola & Trellis Installation", location: "Norfolk Park, Sheffield" },
  { src: "/images/portfolio/project-04.jpg", title: "Raised Beds & Sleeper Work", location: "Sheffield" },
  { src: "/images/portfolio/project-05.jpg", title: "Gravel Pathway & Steps", location: "Sheffield" },
  { src: "/images/portfolio/project-06.jpg", title: "Timber Steps & Fencing", location: "Sheffield" },
  { src: "/images/portfolio/project-07.jpg", title: "Trellis & Boundary Fencing", location: "Sheffield" },
  { src: "/images/portfolio/project-08.jpg", title: "Garden Planting Complete", location: "Sheffield" },
  { src: "/images/portfolio/project-09.jpg", title: "Mature Planting & Borders", location: "Sheffield" },
  { src: "/images/portfolio/project-10.jpg", title: "Courtyard Garden Design", location: "Rotherham" },
  { src: "/images/portfolio/project-11.jpg", title: "School Grounds Project", location: "Sheffield" },
  { src: "/images/portfolio/project-12.jpg", title: "Commercial Landscaping", location: "Sheffield" },
  { src: "/images/portfolio/project-13.jpg", title: "Paving & Border Planting", location: "Sheffield" },
];
    ...
    <InnerPageLayout>
      ...
      <section style={{ background: "#f7f6f3" }} className="pt-16 pb-6 md:pt-20 md:pb-8">
        <div className="container-custom text-center">
          ...
          >
            Garden design, landscaping, patios and planting, fencing and landscaping projects across {client.basedIn}
          </p>
        </div>
      </section>
