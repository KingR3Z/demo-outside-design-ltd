...
const designProcess = [
  { step: "01", title: "Initial Consultation", text: "We visit your property to understand your space, your ideas and your budget. We discuss your lifestyle, how you use your garden, and what you would love it to become." },
  { step: "02", title: "Design Concept", text: "We create a detailed design concept with sketches, planting plans and material selections. You see exactly what your garden will look like before any work begins." },
  { step: "03", title: "Detailed Planning", text: "Tristan refines the design based on your feedback. We finalise materials, planting lists and a clear schedule so you know exactly what to expect and when." },
  { step: "04", title: "Construction Phase", text: "Our team of four handles all hard landscaping — patios, pathways, raised beds, retaining walls and garden structures. Everything is built to last using quality materials." },
  { step: "05", title: "Planting & Finishing", text: "We bring the design to life with carefully selected plants, shrubs and trees. Every plant is chosen for your soil type, aspect and the year-round visual effect we want to achieve." },
  { step: "06", title: "Handover & Aftercare", text: "We walk you through the completed garden and provide aftercare guidance for your new plants. We want your garden to look even better in year two than it does on day one." },
];
